...
public class NIOAcceptor extends Thread {
  private static Log LOG = LogFactory.getLog(NIOAcceptor.class);
  private static AcceptIdGenerator ID_GENERATOR = new AcceptIdGenerator();
  ...
  public void run() {
    ...
    while (true) {
      ...
      try {
        ...
        LOG.warn("Error in NIOAcceptor(" + getName() + "). " +
